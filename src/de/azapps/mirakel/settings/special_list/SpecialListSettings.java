...
public class SpecialListSettings implements OnPreferenceChangeListener {
	...
	private Preference findPreference(String key) {
		return ((SpecialListsSettingsFragment) this.settings).findPreference(key);
	}
	...
	private LayoutInflater getLayoutInflater() {
		return ((SpecialListsSettingsFragment) this.settings).getActivity()
				.getLayoutInflater();
	}

	private PreferenceScreen getPreferenceScreen() {
		return ((SpecialListsSettingsFragment) this.settings).getPreferenceScreen();
	}
	...
	public void setup() throws NoSuchListException {
		if (this.specialList == null) throw new NoSuchListException();
