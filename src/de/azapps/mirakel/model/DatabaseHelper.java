...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	private void createSpecialListsTable(SQLiteDatabase db) {
		...
		db.execSQL("INSERT INTO " + SpecialList.TABLE + " (" + NAME + ","
				...
				+ ") VALUES (" + "'" + this.context.getString(R.string.list_all)
				+ "',1,'')");
		db.execSQL("INSERT INTO " + SpecialList.TABLE + " (" + NAME + ","
				+ SpecialList.ACTIVE + "," + SpecialList.WHERE_QUERY
				+ ") VALUES (" + "'" + this.context.getString(R.string.list_today)
				+ "',1,'" + Task.DUE + " not null and " + Task.DONE
				+ "=0 and date(" + Task.DUE
				+ ")<=date(\"now\",\"localtime\")')");
		db.execSQL("INSERT INTO " + SpecialList.TABLE + " (" + NAME + ","
				+ SpecialList.ACTIVE + "," + SpecialList.WHERE_QUERY
				+ ") VALUES (" + "'" + this.context.getString(R.string.list_week)
				+ "',1,'" + Task.DUE + " not null and " + Task.DONE
				+ "=0 and date(" + Task.DUE
				+ ")<=date(\"now\",\"+7 day\",\"localtime\")')");
		db.execSQL("INSERT INTO " + SpecialList.TABLE + " (" + NAME + ","
				+ SpecialList.ACTIVE + "," + SpecialList.WHERE_QUERY
				+ ") VALUES (" + "'" + this.context.getString(R.string.list_overdue)
				+ "',1,'" + Task.DUE + " not null and " + Task.DONE
				+ "=0 and date(" + Task.DUE
